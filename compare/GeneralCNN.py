...
x = Conv1D(filters=64,kernel_size=16,strides=4,padding='same',kernel_regularizer=l2(1e-4))(input)
x = BatchNormalization()(x)
x = Activation('relu')(x)
x = MaxPooling1D(pool_size=2,strides=2,padding='valid')(x)#########    512    第一层



#
x1 = Conv1D(filters=64,kernel_size=3,strides=1,padding='same',kernel_regularizer=l2(1e-4))(x)
x1 = BatchNormalization()(x1)
x1 = Activation('relu')(x1)
#

#
x2 = Conv1D(filters=64,kernel_size=3,strides=1,padding='same',kernel_regularizer=l2(1e-4))(x1)
...
#b = tf.reduce_mean(x_1_add,axis=1)

#x_1_add = BatchNormalization()(x_1_add)


xx1 = GlobalAveragePooling1D()(x_1_add)


xx2 = Dense(15,activation='softmax',kernel_regularizer=l2(1e-4))(xx1)
...
checkpoint_path = "SK/G+CE/cp.ckpt"
